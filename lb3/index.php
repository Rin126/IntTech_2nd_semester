...
<head>
    ...
    <script>
        function sendRequest1(event) {
            ...
            xhr.open('POST', `request1.php?project_id=${encodeURIComponent(projectId)}&work_date=${encodeURIComponent(workDate)}`, true);
        ...
        function sendRequest2(event) {
            ...
            const xhr = new XMLHttpRequest();
            xhr.open('GET', `request2.php?project_id=${encodeURIComponent(projectId)}`, true);
        ...
        async function sendRequest3(event) {
            ...
            try {
                const response = await fetch(`request3.php?chief=${encodeURIComponent(chiefName)}`);
